...
def format_steam_moves(moves: list, page: int = 0) -> str:
    ...
    if not moves:
        return (
            "🔥 <b>ОХОТА ХИМЕРЫ</b>\n"
            "━━━━━━━━━━━━━━━━━━━━\n\n"
            "👁️ <i>Рынок спокоен — профессиональных движений не обнаружено.</i>\n\n"
            "<i>Химера следит за линиями Pinnacle. Как только острые деньги\n"
            "начнут двигать рынок — ты узнаешь первым.</i>"
        )
